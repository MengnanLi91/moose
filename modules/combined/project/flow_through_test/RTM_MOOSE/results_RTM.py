...
path = os.path.join(my_path, "./porous_flow_geochem_fractured_2D_out.csv")
...
for ax in axis.flat:
    ax.set(xlabel='time(days)', ylabel='mass_frac')

axis[1].set_ylim(-0.025, -0.02)
