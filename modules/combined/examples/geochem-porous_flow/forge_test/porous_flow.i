...
[Variables]
  [f_H]
    initial_condition = 4.1683E-06
  []
  [f_Na]
    initial_condition = 2.0195E-03
  []
  [f_K]
    initial_condition = 1.9189E-05
  []
  [f_Ca]
    initial_condition = 5.6577E-05
  []
  [f_Mg]
    initial_condition = 3.6275E-08
  []
  [f_Al]
    initial_condition = 3.0633E-08
  []
  [f_SiO2]
    initial_condition = 1.5322E-05
  []
  [f_Cl]
    initial_condition = 1.3772E-03
  []
  [f_SO4]
    initial_condition = 3.8359E-04
  []
  [f_HCO3]
    initial_condition = 3.9293E-06
  []
  [f_BOH3]
    initial_condition = 4.18E-05
  []
  [porepressure]
...
[DiracKernels]
  [inject_H]
    ...
    point = ' 0 0 0'
    mass_flux = 2.47929E-07
    variable = f_H
  []
  [inject_Na]
    type = PorousFlowPointSourceFromPostprocessor
    point = ' 0 0 0'
    mass_flux = 0.001529562
    variable = f_Na
  []
  [inject_K]
    type = PorousFlowPointSourceFromPostprocessor
    point = ' 0 0 0'
    mass_flux = 0.000180948
    variable = f_K
  []
  [inject_Ca]
    type = PorousFlowPointSourceFromPostprocessor
    point = ' 0 0 0'
    mass_flux = 0.00020894
    variable = f_Ca
  []
  [inject_Mg]
    type = PorousFlowPointSourceFromPostprocessor
    point = ' 0 0 0'
    mass_flux = 1.7295E-05
    variable = f_Mg
  []
  [inject_Al]
    type = PorousFlowPointSourceFromPostprocessor
  ...
  [inject_SiO2]
    type = PorousFlowPointSourceFromPostprocessor
    point = ' 0 0 0'
    mass_flux = 9.39731E-05
    variable = f_SiO2
  []
  [inject_Cl]
    type = PorousFlowPointSourceFromPostprocessor
    point = ' 0 0 0'
    mass_flux = 0.002699227
    variable = f_Cl
  []
  [inject_SO4]
    type = PorousFlowPointSourceFromPostprocessor
    point = ' 0 0 0'
    mass_flux = 7.39788E-05
    variable = f_SO4
  []
  [inject_HCO3]
    type = PorousFlowPointSourceFromPostprocessor
    point = ' 0 0 0'
    mass_flux = 0.000338903
    variable = f_HCO3
  []
  [inject_BOH3]
    type = PorousFlowPointSourceFromPostprocessor
    point = ' 0 0 0'
    mass_flux = 0.000141959
    variable = f_BOH3
  []
  [inject_H2O]
    type = PorousFlowPointSourceFromPostprocessor
    point = ' 0 0 0'
    mass_flux = 0.994714966
...
[Postprocessors]
  ...
  [mass_extracted]
    ...
    pp_names = 'mass_extracted_H mass_extracted_Na mass_extracted_K mass_extracted_Ca mass_extracted_Mg mass_extracted_SiO2 mass_extracted_Al mass_extracted_Cl mass_extracted_SO4 mass_extracted_HCO3 mass_extracted_BOH3 mass_extracted_H2O'
...
[PorousFlowFullySaturated]
  ...
  mass_fraction_vars = 'f_H f_Na f_K f_Ca f_Mg f_SiO2 f_Al  f_Cl f_SO4 f_HCO3 f_BOH3'
  save_component_rate_in = 'rate_H rate_Na rate_K rate_Ca rate_Mg rate_SiO2 rate_Al  rate_Cl rate_SO4 rate_HCO3 rate_BOH3 rate_H2O' # change in kg at every node / dt
  fp = the_simple_fluid
...
[MultiApps]
  [react]
    ...
    input_files = aquifer_geochemistry_updated.i
...
[Transfers]
  [changes_due_to_flow]
    ...
    source_variable = 'rate_H rate_Na rate_K rate_Ca rate_Mg rate_SiO2 rate_Al  rate_Cl rate_SO4 rate_HCO3 rate_BOH3 rate_H2O temperature'
    variable = 'pf_rate_H pf_rate_Na pf_rate_K pf_rate_Ca pf_rate_Mg pf_rate_SiO2 pf_rate_Al  pf_rate_Cl pf_rate_SO4 pf_rate_HCO3 pf_rate_BOH3 pf_rate_H2O temperature'
    to_multi_app = react
  []
  [massfrac_from_geochem]
    type = MultiAppCopyTransfer
    source_variable = 'massfrac_H massfrac_Na massfrac_K massfrac_Ca massfrac_Mg massfrac_SiO2 massfrac_Al  massfrac_Cl massfrac_SO4 massfrac_HCO3 massfrac_BOH3'
    variable = 'f_H f_Na f_K f_Ca f_Mg f_SiO2 f_Al f_Cl f_SO4 f_HCO3 f_BOH3'
