...
[UserObjects]
  ...
  [definition]
    ...
    basis_species = 'H2O H+ Na+ K+ Ca++ Mg++ SiO2(aq) Al+++ Cl- SO4-- HCO3- B(OH)3'
...
[SpatialReactionSolver]
  ...
  constraint_species = 'H2O              H+                  Na+              K+                 Ca++              Mg++                SiO2(aq)           Al+++               Cl-                SO4--               HCO3-  B(OH)3'
  constraint_value = '  1.0006383866109  1.281e-07        0.08937        0.005307           6.70E-05             3.440e-08      0.004823   5.8096968688789e-17       0.07752          0.006460    0.001329      0.002301'
  ...
  kinetic_species_initial_value = ' 2.61e3               2.9e2            1.3e3             4.7e3                 7e2              0.1e0             0.1e0                3e2             0.1e0                  0.1e0               0.1e0                2e2                 0.1e0              0.1e0                      '
  ...
  source_species_names = 'H2O H+ Na+ K+ Ca++ Mg++ SiO2(aq) Al+++ Cl- SO4-- HCO3- B(OH)3'
  source_species_rates = 'rate_H2O_per_1l rate_H_per_1l rate_Na_per_1l rate_K_per_1l rate_Ca_per_1l rate_Mg_per_1l rate_SiO2_per_1l rate_Al_per_1l rate_Cl_per_1l rate_SO4_per_1l rate_HCO3_per_1l rate_BOH3_per_1l'
...
[AuxKernels]
  ...
  [transported_mass_auxk]
    type = ParsedAux
    coupled_variables = ' transported_H transported_Na transported_K transported_Ca transported_Mg transported_SiO2 transported_Al transported_Cl transported_SO4 transported_HCO3 transported_BOH3 transported_H2O'
    variable = transported_mass
    expression = 'transported_H * 1.0079 + transported_Cl * 35.453 + transported_SO4 * 96.0576 + transported_HCO3 * 61.0171 + transported_SiO2 * 60.0843 + transported_Al * 26.9815 + transported_Ca * 40.08 + transported_Mg * 24.305 + transported_K * 39.0983 + transported_Na * 22.9898 + transported_BOH3*61.8329 + transported_H2O * 18.01801802'
    execute_on = 'timestep_end'
  []
  [massfrac_H_auxk]
    type = ParsedAux
