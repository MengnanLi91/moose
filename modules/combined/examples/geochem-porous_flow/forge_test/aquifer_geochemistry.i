...
[UserObjects]
  ...
  [rate_Siderite]
    ...
    intrinsic_rate_constant = 1E-9
    multiply_by_mass = true
    area_quantity = 10
    activation_energy = 95.0E3
    one_over_T0 = 0.003354
  []
  [definition]
    type = GeochemicalModelDefinition
    database_file = '../../../../geochemistry/database/moose_geochemdb.json'
    basis_species = 'H2O H+ Na+ K+ Ca++ Mg++ Al+++ Fe++ SiO2(aq) Cl- SO4-- HCO3- B(OH)3'
    remove_all_extrapolated_secondary_species = true
    kinetic_minerals = 'Albite Anorthite Calcite Illite K-feldspar Quartz  Phlogopite Anhydrite Clinochl-7A Dolomite Tremolite Siderite'
    kinetic_rate_descriptions = 'rate_Albite rate_Anhydrite rate_Anorthite rate_Calcite rate_Clinochl-7A rate_Illite rate_K-feldspar rate_Quartz rate_Phlogopite rate_Dolomite rate_Tremolite rate_Siderite'
  []
...
[SpatialReactionSolver]
  ...
  constraint_species = 'H2O                 H+               Na+              K+                Ca++              Mg++           Al+++          Fe++                  SiO2(aq)              Cl-                SO4--               HCO3-             B(OH)3'
  constraint_value = '  1.000              -7.025           0.09042         0.005988         8.476e-05          5.999e-08        1.776e-06       1.093e-07             0.004810            0.07665            0.009295            0.003691           0.002309         '
  constraint_meaning = 'kg_solvent_water log10activity bulk_composition  bulk_composition  bulk_composition bulk_composition    bulk_composition  bulk_composition    bulk_composition    bulk_composition   bulk_composition   bulk_composition      bulk_composition'
  constraint_unit = '   kg                dimensionless    moles            moles              moles             moles               moles           moles          moles               moles                moles              moles               moles            '
  initial_temperature = 225
  temperature = temperature
  kinetic_species_name = '        Albite             Anorthite           Calcite       Illite    K-feldspar       Quartz       Phlogopite   Anhydrite Clinochl-7A Dolomite  Tremolite  Siderite'
  kinetic_species_initial_value = '1.32E+04         1.38E+03            4.8E-01        4.8E-01   6.19E+03        1.04E+05       2.22E+03    2.92E+03  4.77E+02     4.8E-01   1.47E+03   4.8E-01 '
  ...
  source_species_names = 'H2O H+ Na+ K+ Ca++ Mg++ Al+++ Fe++ SiO2(aq) Cl- SO4-- HCO3- B(OH)3'
  source_species_rates = 'rate_H2O_per_1l rate_H_per_1l rate_Na_per_1l rate_K_per_1l rate_Ca_per_1l rate_Mg_per_1l rate_Al_per_1l rate_Fe_per_1l rate_SiO2_per_1l rate_Cl_per_1l rate_SO4_per_1l rate_HCO3_per_1l rate_BOH3_per_1l'
...
[AuxVariables]
  ...
  []
  [porosity]
    initial_condition = ${ini_porosity}
  []
  [nodal_void_volume]
  []
...
[AuxKernels]
  ...
  [porosity_auxk]
    type = ParsedAux
    coupled_variables = 'free_cm3_Albite free_cm3_Anhydrite free_cm3_Anorthite free_cm3_Calcite  free_cm3_Clinochl7A free_cm3_Illite free_cm3_Kfeldspar  free_cm3_Quartz  free_cm3_Phlogopite free_cm3_Dolomite free_cm3_Tremolite free_cm3_Siderite '
    expression = '1000.0 / (1000.0 + free_cm3_Albite + free_cm3_Anhydrite + free_cm3_Anorthite + free_cm3_Calcite  + free_cm3_Clinochl7A + free_cm3_Illite + free_cm3_Kfeldspar  + free_cm3_Quartz  + free_cm3_Phlogopite + free_cm3_Dolomite+ free_cm3_Tremolite + free_cm3_Siderite)'
    variable = porosity
...
[Postprocessors]
  ...
  [cm3_mineral]
    ...
    pp_names = 'cm3_Albite cm3_Anhydrite cm3_Anorthite cm3_Calcite cm3_Clinochl-7A cm3_Illite cm3_K-feldspar cm3_Quartz cm3_Phlogopite cm3_Dolomite cm3_Tremolite cm3_Siderite'
